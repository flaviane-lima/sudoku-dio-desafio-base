...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true){
            ...
            switch (option){
                ...
                case 2 -> inputNumber();
                case 3 -> removeNumber();
                case 4 -> shoeCurrentGame();
                case 5 -> shoeGameStatus();
                case 6 -> clearGame();
                case 7 -> finishGame();
                case 8 -> System.out.println(0);
    ...
    private static void startGame(Map<String, String> position) {
        ...
        for (int i = 0; i < BOARD_LIMIT; i++) {
            ...
            for (int j = 0; j < BOARD_LIMIT; j++) {
                var positionConfig = position.get("%,%".formatted(i, j));
    ...
    private static void inputNumber() {
        if (isNull(board)) {
            System.out.println("O jogo foi não foi iniciado");
            return;
        }
    ...
    private static void shoeCurrentGame() {
        if (isNull(board)) {
            System.out.println("O jogo foi não foi iniciado");
            return;
        }
    ...
    private static void shoeGameStatus() {
        if (isNull(board)) {
            System.out.println("O jogo foi não foi iniciado");
            return;
        }
        ...
        if (board.hasErrors()) {
            System.out.println("O jogo contém errroa");
        } else {
            System.out.println("O jogo não tem erro");
        }
